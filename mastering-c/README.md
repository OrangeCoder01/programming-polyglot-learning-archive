# Mastering ${\color{Turquoise}\text{C}}$
...
<br>
most of ${\color{Turquoise}\text{Arduino IDE}}$'s Microcontrollers implementation uses Mastering ${\color{Turquoise}\text{C}}$ language.
