...
Explanation:
```
    The program process number of elements from the user and reverses this sequency
    For example:

        size = 3
        Element_1 = 10, Element_2 = 20, and Element_ -12.
        The array = [10, 20, -12]
...
```
    Practising programming algorithmic skills with arrays.
```
