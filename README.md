...
the complex nature of the code (either conceptually as high-low-nibble data transmission in LCD or heavy-language tools like struct or classes that requires
