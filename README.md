...
<br>${\color{blue}\text{(3.1.2)}}$ Layer ${\color{blue}\text{(2)}}$: The development board family tree folders for ${\color{pink}\text{example}}$: `arduino_uno`, `arduino_mega`, `esp32-wroom-38pins` or etc..
