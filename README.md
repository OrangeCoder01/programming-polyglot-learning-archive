...
from a diverse set of programming languages.
It acts as an archive to store achievements
like challenges completed and projects executed.
...
or following a roadmap generated by AI model as a mentor.

2) Course Curriculum folder:
It is the opposite of the Personal-forge folder;
This folder (named with the name of the course instead) contains the completed challenges and executed projects under the course syllabus and designed roadmap created by the mentor.
 2.1) 100-day-bootcamp ---> Python

These two folders, each contain:

3) Challenges folder:
It holds the tasks that require less system integration, and targets a specific problem such as:
 3.1) Nth largest element in array ---> C++
    which takes a user array of input elements, processing the 
    input elements and extracts the nth order largest element.

4) Projects folder:
It holds the tasks that require system integration, a lot of algorithmic thinking, and data synchronization.
 4.1) Blackjack game ----> Python
 4.2) Bank Simulator ----> C++

Most of the tasks are conceptually explained in either in a README or in a comment inside the code file.
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
The Arduino IDE does not follow the same architecture philosophy;
...
"Arduino Mega" or etc...
3) The debugger folder which contain the debugging code files that comes in handy when facing unexpected component behavior.
And the projects folder which contain the learning difficulty projects.
