...
This section contain the code folders, they contain code files but may also contain a ${\color{tan}\text{README}}$ files which succinctly explain the concept
...
<br>${\color{blue}\text{(3.2.2)}}$ Layer ${\color{blue}\text{(2)}}$: The development board family tree folders for ${\color{pink}\text{example}}$: `arduino_uno`, `arduino_mega`, `esp32-wroom-38pins` or etc..
<br>${\color{blue}\text{(3.2.3)}}$ Layer ${\color{blue}\text{(3)}}$: ${\color{red}\text{projects}}$ and ${\color{gray}\text{debuggers}}$
<br>${\color{blue}\text{(3.2.4)}}$ Layer ${\color{blue}\text{(4)}}$: Code folders
