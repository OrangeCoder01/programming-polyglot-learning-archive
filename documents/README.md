# Documents folder:
This folder holds the README documentation of repeating folders found throughout <br>
the repository such as ${\color{red}\text{personal-forge}}$ which contains personally-made or AI-made ${\color{yellow}\text{challenges}}$ / ${\color{red}\text{projects}}$<br>
<br>

${\color{red}\text{Note}}$:<br>
